...
</script>	<noscript><meta http-equiv="refresh" content="0; URL=/files/pooja.mohite/F386T6GH1/readme-logicane.txt?nojsmode=1" /></noscript>
<script>(function() {
        'use strict';
...
<script>(function() {
	...
	<script type="text/javascript">
		...
		sb('set', 'token', '3307f436963e02d4f9eb85ce5159744c');
					...
					sb('set', 'user_id', "U2B7R9TV4");
							sb('set', 'user_' + "batch", "signup_api");
							sb('set', 'user_' + "created", "2016-09-13");
						sb('set', 'name_tag', "falcondevelopment" + '/' + "divyakoti");
				sb('track', 'pageview');
...
<script>TSSSB.env = (function() {
	...
	<script type="text/javascript">
	    ...
	    <title>README-Logicane.txt | Falcon Development Slack</title>
    <meta name="author" content="Slack">
			...
			<!-- output_css "core" -->
    <link href="https://a.slack-edge.com/f5446/style/rollup-plastic.css" rel="stylesheet" type="text/css" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)">
	...
	<div id="site_nav_contents">
		...
		<div id="user_menu">
			<div id="user_menu_contents">
				<div id="user_menu_avatar">
										<span class="member_image thumb_48" style="background-image: url('https://secure.gravatar.com/avatar/44440965739d32e5394e06d44f6595d6.jpg?s=192&d=https%3A%2F%2Fa.slack-edge.com%2F7fa9%2Fimg%2Favatars%2Fava_0000-192.png')" data-thumb-size="48" data-member-id="U2B7R9TV4"></span>
					<span class="member_image thumb_36" style="background-image: url('https://secure.gravatar.com/avatar/44440965739d32e5394e06d44f6595d6.jpg?s=72&d=https%3A%2F%2Fa.slack-edge.com%2F66f9%2Fimg%2Favatars%2Fava_0000-72.png')" data-thumb-size="36" data-member-id="U2B7R9TV4"></span>
				</div>
				<h3>Signed in as</h3>
				<span id="user_menu_name">divyakoti</span>
			</div>
		</div>
		...
		<div id="footer">
			...
			<ul id="footer_nav">
				...
				<li><a href="https://slack.com/signout/79257063425?crumb=s-1480440689-44e2a8b06a-%E2%98%83" data-qa="sign_out">Sign Out<i class="ts_icon ts_icon_sign_out small_left_margin ts_icon_inherit"></i></a></li>
			</ul>
					...
					<span class="block label">Help</span>
						...
						<span class="block label">Launch</span>
				                    ...
				                    <ul id="header_team_nav" data-qa="team_switcher_menu">
	                        	                            <li class="active">
	                            	<a href="https://falcondevelopment.slack.com/home" target="https://falcondevelopment.slack.com/">
	                            			                            			<i class="ts_icon small ts_icon_check_circle_o active_icon s"></i>
	                            			                            			                            			<i class="team_icon small default" >FD</i>
	                            			                            		<span class="switcher_label team_name">Falcon Development</span>
	                            	</a>
	                            </li>
...
<p class="print_only">
	<strong>Created by pooja.mohite on November 29, 2016 at 9:25 AM</strong><br />
	<span class="subtle_silver break_word">https://falcondevelopment.slack.com/files/pooja.mohite/F386T6GH1/readme-logicane.txt</span>
</p>
...
<div class="alert_container">
	...
	<i class="ts_icon ts_icon_link"></i> Public Link: <a class="file_public_link" href="https://slack-files.com/T2B7K1VCH-F386T6GH1-9e1900cd26" target="new">https://slack-files.com/T2B7K1VCH-F386T6GH1-9e1900cd26</a>
</div></div>

<div id="file_page" class="card top_padding">

	<p class="small subtle_silver no_print meta">
		3KB Plain Text snippet created on <span class="date">November 29th 2016</span>.
...
Vanderbilt Logicane App GUI
************************************************************************

Setup
-------------
To load and execute this app we need Visual Studio 2015 with Xamarin installed in it. 

Requirement
------------------------
* Windows 8.1 or higher version.
* 64bit  
* Hyper-V variable in enabled in BIOS setting.
* Xamarin android player depending runs on oracle VM virtual box.

	External libraries used
	------------------------
	* MPAndroidChart - used as chart library.
	* Xamarin.GooglePlayServices.Plus - for google login
	* Xamarin.Android.Support.v4 - C# binding library
	* Xamarin.Android.Support.Animated.Vector.Drawable - C# binding
	* Xamarin.Android.Support.Vector.Drawable - C# binding
	* Xamarin.GooglePlayServices.Basement - For google login
	* Xamarin.Android.Support.v7.AppCompat - C# binding
	* Xamarin.GooglePlayServices.Base - For google login

Working
-------------
* Logicane starts with a splash screen containing falcon development logo.
* User can login into app using their gmail credentials. As gmail logs in successfully he is provided with three buttons,
	1. Sign out - logs out from the app.
	2. Disconnect - session remains active in background, can reconnect and start using the old session.
	3. Move ahead - Proceed to access the further features of the app.
* On click of Move ahead button depending on whether the user is Patient or therapist, 
	1. Therapist - directed to list of patients
	2. Patient - directed to his visited list of dates.
* Therapist can select particular patient and can view the patients visited list of dates.
* Patient/Therapist can select particular date, and will be able to see the activity graph for that day. 

Binding libraries to project
-----------------------------
* Create a Class Library(Android).
* Add the Weka.dll file as link.
* Build the project.
* Add the project_name.dll created in bin/Debug folder to our project.

Assumptions/Constraints
--------------------------
* If user is first time logger he is assumed to be a patient. Hence Admin need to change it manually in DB to make him therapist.
* Link between a patient and therapist needs to be added to therapistpatientlink table manually by the admin.
* This version of Logicane works only with Android.

Steps to install DB without docker
----------------------------------
* Install MYSQL.
* MYSQL workbench for interactive UI
* Download and Install nodeJS.
* Test API using POSTMAN.


Problems Encountered during building phase of the project
-------------------------------------------------------------
* Xamarin installation in visual studio - 
	- needs windows 10, 64bit.
	
* Integration Problems
	- everytime integrating we need to create a new page and copy sections not the whole body.
	- Cannot add new page and refer the existing page from this page.
	
* Using API to connect to database
	- Followed the post in http://blog.falafel.com/31-days-of-xamarin-android-day-27-using-httpclient-with-xamarin-android/#comment-2711407463
	  but it did not work.
	
* Embedding classes in our.
	- Binding class library - adding .jar and .dll files as a component.
	- Followed https://forums.xamarin.com/discussion/3633/adding-existing-c-library-project and got it done successfully.
	</pre>
	...
	<div class="col span_4_of_6 no_right_padding">
		...
		<form action="https://falcondevelopment.slack.com/files/pooja.mohite/F386T6GH1/readme-logicane.txt"
		id="file_comment_form"
					class="comment_form clearfix"
				method="post">
			<a href="/team/divyakoti" class="member_preview_link" data-member-id="U2B7R9TV4" >
			<span class="member_image thumb_36" style="background-image: url('https://secure.gravatar.com/avatar/44440965739d32e5394e06d44f6595d6.jpg?s=72&d=https%3A%2F%2Fa.slack-edge.com%2F66f9%2Fimg%2Favatars%2Fava_0000-72.png')" data-thumb-size="36" data-member-id="U2B7R9TV4"></span>
		</a>
		<input type="hidden" name="addcomment" value="1" />
	<input type="hidden" name="crumb" value="s-1480440689-c799132ed3-☃" />
...
<!--
	...
	var boot_data = {
		...
		user_id: 'U2B7R9TV4',
		no_login: false,
		version_ts: '1480440169',
		version_uid: '03d6b159080749ca8cdaf210ee5350c54f3c3ab6',
		...
		api_url: '/api/',
		team_url: 'https://falcondevelopment.slack.com/',
		image_proxy_url: 'https://slack-imgs.com/',
		beacon_timing_url: "https:\/\/slack.com\/beacon\/timing",
		beacon_error_url: "https:\/\/slack.com\/beacon\/error",
		clog_url: "clog\/track\/",
		api_token: 'xoxs-79257063425-79263333990-81834426359-a35feed125',
		ls_disabled: false,
		...
		feature_do_not_clear_three_day_old_local_storage: true,
...
//-->
				...
				<!-- output_js "core" -->
<script type="text/javascript" src="https://a.slack-edge.com/f2ac/js/rollup-core_required_libs.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
<script type="text/javascript" src="https://a.slack-edge.com/0519/js/rollup-core_required_ts.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
...
<script type="text/javascript" src="https://a.slack-edge.com/9982f/js/rollup-core_web.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
		...
		<!-- output_js "secondary" -->
<script type="text/javascript" src="https://a.slack-edge.com/206290/js/rollup-secondary_a_required.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
...
<script type="text/javascript" src="https://a.slack-edge.com/8df80/js/codemirror_load.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
		...
		<script type="text/javascript">
				TS.clog.setTeam('T2B7K1VCH');
				TS.clog.setUser('U2B7R9TV4');
			</script>
	...
	<!--
		...
		boot_data.file = {"id":"F386T6GH1","created":1480433140,"timestamp":1480433140,"name":"README-Logicane.txt","title":"README-Logicane.txt","mimetype":"text\/plain","filetype":"text","pretty_type":"Plain Text","user":"U2C64RBDG","editable":true,"size":3394,"mode":"snippet","is_external":false,"external_type":"","is_public":false,"public_url_shared":false,"display_as_bot":false,"username":"","url_private":"https:\/\/files.slack.com\/files-pri\/T2B7K1VCH-F386T6GH1\/readme-logicane.txt","url_private_download":"https:\/\/files.slack.com\/files-pri\/T2B7K1VCH-F386T6GH1\/download\/readme-logicane.txt","permalink":"https:\/\/falcondevelopment.slack.com\/files\/pooja.mohite\/F386T6GH1\/readme-logicane.txt","permalink_public":"https:\/\/slack-files.com\/T2B7K1VCH-F386T6GH1-9e1900cd26","edit_link":"https:\/\/falcondevelopment.slack.com\/files\/pooja.mohite\/F386T6GH1\/readme-logicane.txt\/edit","preview":"************************************************************************ \r\nVanderbilt Logicane App GUI\r\n************************************************************************\r\n\r\nSetup\r","preview_highlight":"\u003Cdiv class=\"CodeMirror cm-s-default CodeMirrorServer\" oncopy=\"if(event.clipboardData){event.clipboardData.setData('text\/plain',window.getSelection().toString().replace(\/\\u200b\/g,''));event.preventDefault();event.stopPropagation();}\"\u003E\n\u003Cdiv class=\"CodeMirror-code\"\u003E\n\u003Cdiv\u003E\u003Cpre\u003E************************************************************************ \u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003EVanderbilt Logicane App GUI\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E************************************************************************\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003ESetup\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003C\/div\u003E\n\u003C\/div\u003E\n","lines":77,"lines_more":72,"preview_is_truncated":true,"channels":[],"groups":[],"ims":["D2C46MN9Z"],"comments_count":0};
...
<!-- slack-www-hhvm63 / 2016-11-29 09:31:29 / v03d6b159080749ca8cdaf210ee5350c54f3c3ab6 / B:H -->
